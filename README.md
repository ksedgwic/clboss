...
CLBOSS requires **Core Lightning v26.06 or later**.  Its probing
subsystems build routes from the `getroutes` per-hop
...
values that would misprice routes.  CLBOSS checks the CLN version at
